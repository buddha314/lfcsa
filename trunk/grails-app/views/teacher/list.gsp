                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="legal_name_middle" title="${message(code: 'teacher.legal_name_middle.label', default: 'Legalnamemiddle')}" />
                    ...
                    <g:each in="${teacherInstanceList}" status="i" var="teacherInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: teacherInstance, field: "legal_name_middle")}</td>
