                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="emails"><g:message code="teacher.emails.label" default="Emails" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: teacherInstance, field: 'emails', 'errors')}">
                                    <g:select name="emails" from="${org.lfcsa.calpads.EmailAddress.list()}" multiple="yes" optionKey="id" size="5" value="${teacherInstance?.emails*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="phones"><g:message code="teacher.phones.label" default="Phones" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: teacherInstance, field: 'phones', 'errors')}">
                                    <g:select name="phones" from="${org.lfcsa.calpads.PhoneContact.list()}" multiple="yes" optionKey="id" size="5" value="${teacherInstance?.phones*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="roles"><g:message code="teacher.roles.label" default="Roles" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: teacherInstance, field: 'roles', 'errors')}">
                                    <g:select name="roles" from="${org.lfcsa.calpads.Role.list()}" multiple="yes" optionKey="id" size="5" value="${teacherInstance?.roles*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: teacherInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${org.lfcsa.calpads.User.list()}" optionKey="id" value="${teacherInstance?.user?.id}"  />
                                </td>
                            </tr>
