            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="classroom.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: classroomInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="classroom.room_number.label" default="Roomnumber" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: classroomInstance, field: "room_number")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="classroom.teacher.label" default="Teacher" /></td>
                            
                            <td valign="top" class="value"><g:link controller="teacher" action="show" id="${classroomInstance?.teacher?.id}">${classroomInstance?.teacher?.encodeAsHTML()}</g:link></td>
