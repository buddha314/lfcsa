                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="phones"><g:message code="administrator.phones.label" default="Phones" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: administratorInstance, field: 'phones', 'errors')}">
                                    <g:select name="phones" from="${org.lfcsa.calpads.PhoneContact.list()}" multiple="yes" optionKey="id" size="5" value="${administratorInstance?.phones*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="emails"><g:message code="administrator.emails.label" default="Emails" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: administratorInstance, field: 'emails', 'errors')}">
                                    <g:select name="emails" from="${org.lfcsa.calpads.EmailAddress.list()}" multiple="yes" optionKey="id" size="5" value="${administratorInstance?.emails*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="roles"><g:message code="administrator.roles.label" default="Roles" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: administratorInstance, field: 'roles', 'errors')}">
                                    <g:select name="roles" from="${org.lfcsa.calpads.Role.list()}" multiple="yes" optionKey="id" size="5" value="${administratorInstance?.roles*.id}" />
                                </td>
                            </tr>
