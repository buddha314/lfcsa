                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="legal_name_last" title="${message(code: 'person.legal_name_last.label', default: 'Legalnamelast')}" />
                    ...
                    <g:each in="${personInstanceList}" status="i" var="personInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: personInstance, field: "legal_name_last")}</td>
