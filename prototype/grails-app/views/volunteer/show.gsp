            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="volunteer.skills.label" default="Skill" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${volunteerInstance.skills}" var="s">
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${volunteerInstance?.user?.id}">${volunteerInstance?.user?.encodeAsHTML()}</g:link></td>
